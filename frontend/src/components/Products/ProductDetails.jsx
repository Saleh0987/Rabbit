...
const ProductDetails = ({ productId }) => {
 ...
 const handleAddToCart = () => {
  ...
  if ((needsSize && !selectedSize) || (needsColor && !selectedColor)) {
    toast.error("Please select the required options before adding to the cart.", {
      duration: 1000,
    });
    return;
  }
  ...
  return (
    <div className="p-6">
      {selectedProduct && (
        <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow" data-aos="fade-up">
          ...
          ${mainImage === image.url ? "border-black" : "border-gray-300"}`} />
            ...
            <div
                  ...
                  {selectedProduct?.colors?.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border
                       ${selectedColor === color ? "border-4 border-black scale-130 transition-all" : "border-gray-300"}`}
                      style={{
              ...
              <div className="mb-6 " data-aos="fade-up">
                ...
                <div
                  ...
                  <button
                    ...
                    {loading ? <BiLoaderAlt className="animate-spin text-[24px]" /> : "-"}
                  </button>
              ...
              <button
                ...
                className={`bg-maincolor text-white py-2 px-6 rounded w-full mb-4  hover:bg-red-500
