      ...
      {orders.length > 0 ? (
       orders.map((order) => (
         <tr key={order._id}
           ...
           className="border-b border-gray-300  hover:border-gray-500 cursor-pointer transition-all">
         ...
         <td className="py-2 px-2 sm:py-4 sm:px-4">
          <span className={`${order.isDelivered ? "bg-blue-300 text-black" : "bg-red-100 text-red-700"}
